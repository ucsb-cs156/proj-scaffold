...
@WebMvcTest(controllers = LegacyAssessmentController.class)
...
public class LegacyAssessmentControllerTests extends ControllerTestCase {
  ...
  public void any_user_can_get_questions_for_assessment() throws Exception {
    ...
    mockMvc
        .perform(get("/api/legacy/assessments/123e4567-e89b-12d3-a456-426614174000/questions"))
        .andExpect(status().isOk())
        .andExpect(content().contentType("application/json"))
        .andExpect(content().json(expectedJson));
  }
